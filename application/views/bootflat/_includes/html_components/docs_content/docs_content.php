<div id="docs-quick-start">
    ...
    <h2><?php echo lang('Quick start') ?></h2>
    ...
    <div id="docs-installation">
        ...
        <div><img src="<?php echo URL_UPLOAD ?>/app-ss-01.png" class="img-responsive" /></div>
    ...
    <div id="docs-updating">
        ...
        <h4 style="margin-top: 30px"><?php echo lang('From version 2.2.10 to a recent version') ?></h4>
        ...
        <h4 style="margin-top: 30px"><?php echo lang('From version 2.2.9 (and below) to a recent version') ?></h4>
        ...
        <h4 style="margin-top: 30px"><?php echo lang('From version 1.0.0 (also known as ACME Engine) to a recent version') ?></h4>
    ...
    <div id="docs-license">
        ...
        <p><?php echo lang('Basicly, ACME Framework is Free. EXCEPT FOR ORACLE DATABASES.')?></p>
        <p><?php echo lang('It is developed under de Creative Commons Attribution 3.0 Unported. See more on')?> <a href="http://creativecommons.org/licenses/by/3.0/">http://creativecommons.org/licenses/by/3.0/</a></p>
    </div>
...
<div id="docs-overview">
    ...
    <p><?php echo lang('ACME Framework is a CodeIgniter powerful PHP pre-application. After installed on your server, it become an awesome single new application with a lot of features like a login page, users and groups management, internationalisation, and more.') ?></p>
    ...
    <p><?php echo lang('You will be able to create new modules with a special module called') . ' <strong>' . lang('Module Maker') . '</strong>. '. lang('Through this module a new one is created with all necessary module/controller rules.') ?></p>
    ...
    <div id="docs-modules">
        ...
        <p>
            ...
            <code>ACME_Module_Controller</code>.
        ...
        <div class="table-responsive">
            ...
            <table class="table table-hover table-bordered no-footer">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><code>public $this->description</code></td>
                        <td>string</td>
                        <td><?php echo lang('A brief module description.') ?></td>
                    </tr>

                    <tr>
                        <td><code>public $this->sql_list</code></td>
                        <td>string</td>
                        <td>
                    ...
                    <tr>
                        <td><code>public $this->menus</code></td>
                        <td>array()</td>
                        <td>
                    ...
                    <tr>
                        <td><code>public $this->actions</code></td>
                        <td>array()</td>
                        <td>
        ...
        <p><?php echo lang('You do not have to worry about creating modules mannually. Just uses the Module Maker to build new modules that everything is set up.')?></p>
        ...
        <div id="img-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active"><img src="<?php echo URL_UPLOAD ?>/app-dashboard.png" class="img-responsive img-rounded"/></div>
                
                <div class="item"><img src="<?php echo URL_UPLOAD ?>/app-administration.png" class="img-responsive img-rounded"/></div>
                
                <div class="item"><img src="<?php echo URL_UPLOAD ?>/app-module-maker.png" class="img-responsive img-rounded"/></div>
                
                <div class="item"><img src="<?php echo URL_UPLOAD ?>/app-users.png" class="img-responsive img-rounded"/></div>

                <div class="item"><img src="<?php echo URL_UPLOAD ?>/app-menus.png" class="img-responsive img-rounded"/></div>

                <div class="item"><img src="<?php echo URL_UPLOAD ?>/app-logs.png" class="img-responsive img-rounded"/></div>

                <div class="item"><img src="<?php echo URL_UPLOAD ?>/app-settings.png" class="img-responsive img-rounded"/></div>
    ...
    <div id="docs-application-menus">
        <h3><?php echo lang('Application menus') ?></h3>
        <p>
            <?php echo lang('Every new application has a set of menus and here is one rule about ACME Framework:')?>
        ...
        <p><?php echo lang('If the ROOT group has five registered menus, then all those menus will appear for all ROOT users. The same happens for the other created groups.')?></p>
        <p><?php echo lang('Lets suppose you create a group called Admin and you register three menus for this group. All users of group Admin will see only these three registered menus.')?></p>
    </div>
    ...
    <div id="docs-permissions">
        ...
        <p>
            <?php echo lang('Permissions are used to check if an user is allowed to do some action or not. And here is one more important rule about ACME Framework:')?>
...
<div id="docs-constants">
    ...
    <h2><?php echo lang('PHP constants and session') ?></h2>
    ...
    <div class="table-responsive">
        ...
        <table class="table table-hover table-bordered no-footer">
            ...
            <tbody>
                ...
                <tr>
                    <td><code>URL_INCLUDE</code></td>
                    <td><code>$('#URL_INCLUDE').val()</code></td>
                    <td><?php echo lang('URL that points to _includes folder, inside the current template.') ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><code>PATH_INCLUDE</code></td>
                    <td><code>$('#PATH_INCLUDE').val()</code></td>
                    <td><?php echo lang('Relative path that points to _includes folder, inside the current template.') ?></td>
                </tr>
                <tr>
    ...
    <div class="table-responsive">
        ...
        <table class="table table-hover table-bordered no-footer">
            ...
            <tbody>
                <tr>
                    <td><code>$this->session->userdata('id_user')</code></td>
                    <td><?php echo lang('ID of current logged user.') ?></td>
                </tr>
                <tr>
                    <td><code>$this->session->userdata('url_default')</code></td>
                    <td><?php echo lang('URL that points to default page of current logged user.') ?></td>
                </tr>
                <tr>
                    <td><code>$this->session->userdata('user_name')</code></td>
                    <td><?php echo lang('Name of current logged user.') ?></td>
                </tr>
                <tr>
                    <td><code>$this->session->userdata('email')</code></td>
                    <td><?php echo lang('Email of current logged user.') ?></td>
                </tr>
                <tr>
                    <td><code>$this->session->userdata('user_group')</code></td>
                    <td><?php echo lang('Group name of current logged user.') ?></td>
                </tr>
                <tr>
                    <td><code>$this->session->userdata('language')</code></td>
    ...
    <div class="table-responsive">
        ...
        <table class="table table-hover table-bordered no-footer">
            ...
            <tbody>
                ...
                <tr>
                    <td><strong>Helper Log</strong></td>
                    <td>Log</td>
                </tr>
                <tr>
    ...
    <div id="docs-template-helper">
        ...
        <div class="box-code">
            ...
            <p>
                ...
                <code>TEMPLATE</code>
                <?php echo lang('/_includes/html_components/')?>
...
<div id="docs-libraries">
    ...
    <div class="table-responsive">
        ...
        <table class="table table-hover table-bordered no-footer">
            ...
            <tbody>
                ...
                <tr>
                    <td><strong>Library Log</strong></td>
                    <td><code>$this->log</code></td>
                </tr>
                <tr>
    ...
    <div id="docs-log-library">
        ...
        <h3>
            <?php echo lang('Log library') ?>
            <small><code class="text-muted">$this->log</code></small>
        </h3>
    ...
    <div id="docs-template-library">
        ...
        <div class="box-code">
            ...
            <p>
                ...
                <code>TEMPLATE</code>
                /_includes/html_components/menu/menu.php.
            </p>
        </div>
        ...
        <div class="box-code">
            ...
            <p>
                ...
                <code>TEMPLATE</code>/_includes/html_components/user_info/user_info.php
        ...
        <div class="box-code">
            ...
            <p>
                ...
                <code>TEMPLATE</code>/_includes/html_components/logo_area/logo_area.php
...
<div id="docs-html-components">
    ...
    <h2><?php echo lang('HTML components') ?></h2>
    ...
    <p><code>application/views/TEMPLATE/_includes/html_components/COMPONENT_NAME/COMPONENT_NAME.php</code></p>
    ...
    <div id="docs-html-components-generic-table">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <img class="img-responsive" src="<?php echo URL_UPLOAD ?>/docs-html-components-generic-table.png" />
            </div>
        ...
        <div class="box-code">
            ...
            <p><code>application/views/TEMPLATE/_includes/html_components/generic_table/generic_table.php</code></p>
    ...
    <div id="docs-html-components-image">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <img class="img-responsive" src="<?php echo URL_UPLOAD ?>/docs-html-components-image.png" />
            </div>
        ...
        <div class="box-code">
            <h4><?php echo lang('Placed at')?></h4>
            <p><code>application/views/TEMPLATE/_includes/html_components/image/image.php</code></p>
            <h4><?php echo lang('How to load')?></h4>
            <p>
    ...
    <div id="docs-html-components-logo-area">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <img class="img-responsive" src="<?php echo URL_UPLOAD ?>/docs-html-components-logo-area.png" />
            </div>
        ...
        <div class="box-code">
            <h4><?php echo lang('Placed at')?></h4>
            <p><code>application/views/TEMPLATE/_includes/html_components/logo_area/logo_area.php</code></p>
            <h4><?php echo lang('How to load')?></h4>
            <p>
    ...
    <div id="docs-html-components-menu">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <img class="img-responsive" src="<?php echo URL_UPLOAD ?>/docs-html-components-menu.png" />
            </div>
        ...
        <div class="box-code">
            <h4><?php echo lang('Placed at')?></h4>
            <p><code>application/views/TEMPLATE/_includes/html_components/menu/menu.php</code></p>
            <h4><?php echo lang('How to load')?></h4>
            <p>
                <?php echo lang('Through the call')?>
                <code>$this->template->load_menu ()</code>.
    ...
    <div id="docs-html-components-message">
        ...
        <div class="box-code">
            <h4><?php echo lang('Placed at')?></h4>
            <p><code>application/views/TEMPLATE/_includes/html_components/message/message.php</code></p>
            <h4><?php echo lang('How to load')?></h4>
            <p>
                <?php echo lang('Through the helper function')?>
    ...
    <div id="docs-html-components-module-action">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <img class="img-responsive" src="<?php echo URL_UPLOAD ?>/docs-html-components-module-action.png" />
            </div>
        ...
        <div class="box-code">
            <h4><?php echo lang('Placed at')?></h4>
            <p><code>application/views/TEMPLATE/_includes/html_components/module_action/module_action.php</code></p>
            <h4><?php echo lang('How to load')?></h4>
    ...
    <div id="docs-html-components-module-form-field">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <img class="img-responsive" src="<?php echo URL_UPLOAD ?>/docs-html-components-module-form-field.png" />
            </div>
        ...
        <div class="box-code">
            <h4><?php echo lang('Placed at')?></h4>
            <p><code>application/views/TEMPLATE/_includes/html_components/module_form_field/module_form_field.php</code></p>
            <h4><?php echo lang('How to load')?></h4>
    ...
    <div id="docs-html-components-user-info">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <img class="img-responsive" src="<?php echo URL_UPLOAD ?>/docs-html-components-user-info.png" />
            </div>
        ...
        <div class="box-code">
            <h4><?php echo lang('Placed at')?></h4>
            <p><code>application/views/TEMPLATE/_includes/html_components/user_info/user_info.php</code></p>
            <h4><?php echo lang('How to load')?></h4>
            <p>
                <?php echo lang('Through the call')?>
...
<div id="docs-javascript">
    ...
    <h2><?php echo lang('Javascript') ?></h2>
    ...
    <p>
        ...
        <code>application/views/TEMPLATE/_includes/js/app_functions.js</code>.
    </p>
